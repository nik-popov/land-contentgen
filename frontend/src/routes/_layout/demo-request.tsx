...
function RequestDemoPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://apis.brightcreditservices.com/api/v1/utils/demo-request/', {
        method: 'POST',
        headers: {
          ...
          <Box w="full" as="form" onSubmit={handleSubmit} mt={6} bg="white" p={8} borderRadius="md" boxShadow="sm">
            <VStack spacing={6} align="start">
              ...
              <FormControl isRequired mt={4}>
                ...
                >
                  I agree to receive communications about Bright Credit services. I understand that my information will be processed in accordance with the 
