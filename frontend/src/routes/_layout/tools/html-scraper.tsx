        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Flex justify="space-between" flexWrap="wrap" gap={6}>
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.400">Dependable Data Retrieval</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.400">Developer-Centric APIs</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.400">Robust Infrastructure</Heading>
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="orange.400">Data Extraction Tools</Heading>
              <List spacing={3}>
            ...
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="orange.400">Developer Tools</Heading>
              <List spacing={3}>
                <ListItem display="flex">
                  <ListIcon as={CheckCircleIcon} color="orange.400" mt={1} />
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.400">E-commerce Leader Boosts Market Position</Heading>
              <Text mb={4}>
            ...
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.400">Real Estate Startup Scales Coverage</Heading>
              <Text mb={4}>
