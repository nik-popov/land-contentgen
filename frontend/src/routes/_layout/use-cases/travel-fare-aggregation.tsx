        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Flex justify="space-between" flexWrap="wrap" gap={6}>
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="red.600">Comprehensive Fare Data</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="red.600">Real-time Rate Tracking</Heading>
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="red.600">Data Collection & Normalization</Heading>
              <List spacing={3}>
            ...
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="red.600">Analytics & Intelligence</Heading>
              <List spacing={3}>
                <ListItem display="flex">
                  <ListIcon as={CheckCircleIcon} color="red.600" mt={1} />
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="red.600">OTA Increases Conversion Rate by 35%</Heading>
              <Text mb={4}>
            ...
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="red.600">Hotel Chain Optimizes Revenue Management</Heading>
              <Text mb={4}>
        ...
        <Box maxW="1200px" mx="auto" px={4} textAlign="center">
          ...
          <Box bg="white" p={6} borderRadius="md" boxShadow="md">
            <SimpleGrid columns={{ base: 2, md: 3, lg: 6 }} spacing={4} mt={8}>
              ...
              <VStack>
                <Text fontWeight="bold" color="red.600">Hotel Chains</Text>
                <Text>35,000+</Text>
                <Text>Properties</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="red.600">Car Rentals</Text>
                <Text>650+</Text>
                <Text>Agencies</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="red.600">Tour Operators</Text>
                <Text>420+</Text>
                <Text>Companies</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="red.600">Cruise Lines</Text>
                <Text>180+</Text>
                <Text>Operators</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="red.600">OTAs & Metasearch</Text>
                <Text>350+</Text>
                <Text>Platforms</Text>
              </VStack>
            </SimpleGrid>
