...
function HTMLScraperPage() {
  ...
  const scraperFeatures = [
    { 
      ...
      description: "Extract data from JavaScript-rendered websites and SPAs with our headless browser integration", 
    ...
    { 
      ...
      description: "Target specific content with precision using complex CSS and XPath selectors for exact data extraction", 
    ...
    { 
      ...
      description: "Convert any website into a structured API with customizable JSON outputs for your specific needs", 
      icon: "https://raw.githubusercontent.com/marwin1991/profile-technology-icons/refs/heads/main/icons/rest.png" 
    },
    { 
      title: "Data Validation", 
      description: "Ensure data quality with automatic type detection, validation rules, and data cleansing", 
  ...
  return (
    <>
      ...
      <Box py={16} bg="blue.50" color="gray.800">
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Text fontSize="xl" textAlign="center" mb={12} maxW="800px" mx="auto">
            Transform any website into a structured API with our powerful HTML scraping infrastructure.
            Extract valuable data, automate workflows, and integrate web content into your applications.
          </Text>
          
          <Flex justify="space-between" flexWrap="wrap" gap={6}>
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.400">Reliable Data Extraction</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.400">Developer-Friendly APIs</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.400">Enterprise-Grade Infrastructure</Heading>
      ...
      <Box py={16} bg="white">
        <Box maxW="1200px" mx="auto" px={4}>
          <Heading as="h2" size="xl" textAlign="center" mb={8} fontWeight="medium">
            Key Benefits of HTML Scraper APIs
          </Heading>
          
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr", lg: "1fr 1fr 1fr" }} gap={10} mt={10}>
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.400">85%</StatNumber>
            ...
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.400">99.9%</StatNumber>
            ...
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.400">3x</StatNumber>
      ...
      <Box py={16} bg="blue.50">
        <Box maxW="1200px" mx="auto" px={4}>
          <Heading as="h2" size="xl" textAlign="center" mb={12} fontWeight="medium">
            Industry-Specific Scraping Applications
          </Heading>
      ...
      <Box py={16} bg="white">
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Text fontSize="lg" textAlign="center" mb={12} maxW="700px" mx="auto">
            Our HTML scraper APIs provide sophisticated extraction techniques that handle even the most complex websites
          </Text>
      ...
      <Box py={16} bg="blue.50">
        <Box maxW="1200px" mx="auto" px={4}>
          <Heading as="h2" size="xl" textAlign="center" mb={8} fontWeight="medium">
            HTML Scraper API Platform Features
          </Heading>
          
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="orange.400">Extraction Capabilities</Heading>
              <List spacing={3}>
                <ListItem display="flex">
                  <ListIcon as={CheckCircleIcon} color="orange.400" mt={1} />
            ...
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="orange.400">Developer Experience</Heading>
              <List spacing={3}>
                <ListItem display="flex">
                  <ListIcon as={CheckCircleIcon} color="orange.400" mt={1} />
      ...
      <Box py={16} bg="white">
        <Box maxW="1200px" mx="auto" px={4}>
          <Heading as="h2" size="xl" textAlign="center" mb={12} fontWeight="medium">
            HTML Scraper Success Stories
          </Heading>
          
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.400">E-commerce Platform Increases Competitive Edge</Heading>
              <Text mb={4}>
              ...
              <Text fontStyle="italic" fontSize="sm" color="gray.600">
                "The real-time data from the HTML scraper APIs has transformed our pricing strategy. We're now 
                able to respond to market changes within minutes instead of days, giving us a decisive advantage."
              </Text>
            </Box>
            
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.400">Real Estate Tech Startup Expands Market Coverage</Heading>
              <Text mb={4}>
              ...
              <Text fontStyle="italic" fontSize="sm" color="gray.600">
                "The HTML scraper APIs allowed us to scale our coverage exponentially without growing our engineering 
      ...
      <Box py={16} bg="blue.50">
        <Box maxW="1200px" mx="auto" px={4} textAlign="center">
          ...
          <Text fontSize="lg" mb={12} maxW="700px" mx="auto">
            Our HTML scraper APIs integrate seamlessly with your existing development stack and business tools
          </Text>
      ...
      <Box py={16} bg="blue.50">
        <Box maxW="1200px" mx="auto" px={4} textAlign="center">
          ...
          <Flex justify="center" gap={8} flexWrap="wrap">
            ...
            <Image src="https://raw.githubusercontent.com/marwin1991/profile-technology-icons/refs/heads/main/icons/elastic.png" alt="Elastic" boxSize="50px" />
            ...
            <Image src="https://raw.githubusercontent.com/marwin1991/profile-technology-icons/refs/heads/main/icons/fastapi.png" alt="FastAPI" boxSize="50px" />
          </Flex>
        </Box>
      </Box>
