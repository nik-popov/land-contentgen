...
function BlogPostDetails() {
  ...
  // Extract the wildcard parameter from the URL
  ...
  // Construct the full path to match the blog post data
  const fullPath = `/resources/blogs/${path}`;
  console.log('Requested path:', fullPath);
  console.log('Available post paths:', posts.map(p => p.path));
...
// Update the route to use a wildcard
