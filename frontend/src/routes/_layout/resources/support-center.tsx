    ...
    <>
      ...
      {/* <Box py={16} bg="blue.50">
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Text fontSize="lg" textAlign="center" mb={12} maxW="700px" mx="auto">
            Our team of technical experts is ready to help you overcome any challenges
          </Text>
          
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr", lg: "1fr 1fr 1fr" }} gap={8}>
            <VStack align="center" p={6} bg="white" borderRadius="md" boxShadow="sm">
              <Image
                src="https://api.dicebear.com/6.x/personas/svg?seed=John&backgroundColor=b6e3f4"
                alt="Technical Support Team"
                borderRadius="full"
                boxSize="120px"
                mb={4}
              />
              <Heading as="h3" size="md">Technical Support</Heading>
              <Text textAlign="center" color="gray.600">
                Our frontline team for troubleshooting issues, answering questions, and guiding you through technical challenges.
              </Text>
              <HStack mt={4}>
                <Tag colorScheme="blue">API Support</Tag>
                <Tag colorScheme="blue">Data Collection</Tag>
                <Tag colorScheme="blue">Proxies</Tag>
              </HStack>
            </VStack>
            
            <VStack align="center" p={6} bg="white" borderRadius="md" boxShadow="sm">
              <Image
                src="https://api.dicebear.com/6.x/personas/svg?seed=Emily&backgroundColor=b6e3f4"
                alt="Implementation Specialists"
                borderRadius="full"
                boxSize="120px"
                mb={4}
              />
              <Heading as="h3" size="md">Implementation Specialists</Heading>
              <Text textAlign="center" color="gray.600">
                Experts dedicated to helping you integrate our solutions into your workflow and customize them to your needs.
              </Text>
              <HStack mt={4}>
                <Tag colorScheme="blue">Integration</Tag>
                <Tag colorScheme="blue">Customization</Tag>
                <Tag colorScheme="blue">Best Practices</Tag>
              </HStack>
            </VStack>
            
            <VStack align="center" p={6} bg="white" borderRadius="md" boxShadow="sm">
              <Image
                src="https://api.dicebear.com/6.x/personas/svg?seed=Michael&backgroundColor=b6e3f4"
                alt="Account Managers"
                borderRadius="full"
                boxSize="120px"
                mb={4}
              />
              <Heading as="h3" size="md">Account Managers</Heading>
              <Text textAlign="center" color="gray.600">
                Dedicated points of contact for enterprise customers, ensuring your business needs are met and exceeded.
              </Text>
              <HStack mt={4}>
                <Tag colorScheme="blue">Strategy</Tag>
                <Tag colorScheme="blue">Scaling</Tag>
                <Tag colorScheme="blue">Enterprise</Tag>
              </HStack>
            </VStack>
          </Grid>
        </Box>
