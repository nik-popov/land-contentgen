            ...
            <VStack spacing={6} align="start">
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} w="full">
                <FormControl isRequired>
                  ...
                  <Input type="text" placeholder="Enter your first name" focusBorderColor="blue.400" />
                </FormControl>
                
                <FormControl isRequired>
                  <FormLabel>Last Name</FormLabel>
                  <Input type="text" placeholder="Enter your last name" focusBorderColor="blue.400" />
                </FormControl>
              </SimpleGrid>
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} w="full">
                <FormControl isRequired>
                  ...
                  <Input type="email" placeholder="Enter your business email" focusBorderColor="blue.400" />
                </FormControl>
                
                <FormControl isRequired>
                  <FormLabel>Phone Number</FormLabel>
                  <Input type="tel" placeholder="Enter your phone number" focusBorderColor="blue.400" />
                </FormControl>
              </SimpleGrid>
              
              <FormControl isRequired>
                <FormLabel>Company Name</FormLabel>
                <Input type="text" placeholder="Enter your company name" focusBorderColor="blue.400" />
              </FormControl>
              
              <FormControl isRequired>
                <FormLabel>Job Title</FormLabel>
                <Input type="text" placeholder="Enter your job title" focusBorderColor="blue.400" />
              </FormControl>
